...
import { collection, query, onSnapshot, doc, updateDoc, orderBy, getDoc, arrayUnion, deleteField, addDoc, setDoc, getDocs, where, limit, getCountFromServer } from "https://www.gstatic.com/firebasejs/11.0.0/firebase-firestore.js";
...
function loadApplications(filterId = null) {
    ...
    const targetCycleId = filterId || window.selectedCycleId;
    const q = targetCycleId 
    ? query(collection(db, "applications"), where("cycleId", "==", targetCycleId), orderBy("lastUpdated", "desc"))
