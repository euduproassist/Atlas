    ...
    <div style="display: flex; flex-direction: column; gap: 30px;"> 
        <div style="border: 1px solid #eee; border-radius: 8px; padding: 20px; background: #fafcfe;">
            ...
            <div style="border-top: 1px solid #eee; pt: 20px; margin-top: 10px;">
                ...
                <button onclick="saveStatusUpdate(this)" style="width: 100%; background: #4a90e2; color: white; border: none; padding: 12px; border-radius: 6px; font-weight: 700; cursor: pointer; letter-spacing: 0.5px; font-size: 0.8rem;">
                    UPDATE STATUS
                </button>
            </div>
        </div>
