...
registerForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const verificationLink = `https://${authDomain}/__/auth/action?mode=verifyEmail&continueUrl=${encodeURIComponent(window.location.origin + "/login.html")}&apiKey=${apiKey}`;
