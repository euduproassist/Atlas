...
registerForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const verificationLink = `https://${authDomain}/__/auth/handler?mode=verifyEmail&continueUrl=${encodeURIComponent(window.location.origin + "/login.html")}&apiKey=${apiKey}`;
                ...
                html: `
                    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 10px; padding: 20px; border-top: 5px solid #4a90e2;">
                        ...
                        <div style="text-align: center; margin: 35px 0;">
                            <a href="${verificationLink}" style="background-color: #4a90e2; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">VERIFY MY ACCOUNT</a>
                        </div>
